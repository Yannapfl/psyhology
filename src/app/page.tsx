...
export default function Home() {
  ...
  const handleClick = () => {
    if (!checkedClient && !checkedPsyhology) {
      alert("Выберете роль");
      return;
    }
      ...
      <div style={{ width: '95%', margin: '0'}}>
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Image
            src={logo}
            alt="logo"
            style={{ display: "flex", margin: "24px auto" }}
          />
        </div>
            ...
            <div className={styles.flexboxtwo}>
              <div
                className={`${styles.selectmodule} ${
                  checkedClient ? styles["module-active"] : ""
                }`}
                onClick={() => {
              ...
              >
                <div className={styles.imageSelect}>
                  <UserIcon style={{ color: checkedClient ? "#10603C" : "" }} />
              ...
              <div
                className={`${styles.selectmodule} ${
                  checkedPsyhology ? styles["module-active"] : ""
                }`}
                onClick={() => {
              ...
              >
                <div className={styles.imageSelect}>
                  <UserIcon
                    style={{ color: checkedPsyhology ? "#10603C" : "" }}
                  />
                  <div className={styles.checkboxWrapper}>
                    <input
                      type="checkbox"
